...
<section class="hero" style="background: linear-gradient(135deg, var(--color-navy) 0%, var(--color-navy-light) 100%); padding: 8rem 0 4rem; min-height: auto;">
    <div class="hero-container">
        <h1 class="hero-title" style="color: white; font-size: 2.5rem;">Modifier Service</h1>
                ...
                <form method="POST" action="{{ route('admin.services.update', $service) }}">
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <textarea id="short_description" name="short_description" rows="3" required
                                  style="width: 100%; padding: 0.75rem; border: 1px solid var(--color-gray-300); border-radius: var(--border-radius-md); font-size: 1rem;">{{ old('short_description', $service->short_description) }}</textarea>
                    </div>
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <textarea id="description" name="description" rows="8" required
                                  style="width: 100%; padding: 0.75rem; border: 1px solid var(--color-gray-300); border-radius: var(--border-radius-md); font-size: 1rem;">{{ old('description', $service->description) }}</textarea>
                    </div>
